...
export const PERMISSION_CATALOG: PermissionSeed[] = [
  ...
  { key: 'faq.view', description: 'View tenant Q&A questions and answers.', group: 'Support' },
  { key: 'faq.ask', description: 'Submit tenant Q&A questions.', group: 'Support' },
  { key: 'faq.answer', description: 'Answer tenant Q&A questions.', group: 'Support' },
